...
// Handle Delete Category (now even if used)
...
<head>
    <meta charset="UTF-8">
    <title>Manage Categories - Prime Report</title>
    <style>
...
<body>
    ...
    <div class="side-panel" id="sidePanel">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="admin_manage_categories.php" class="nav-link active">
                ...
                <table>
                    ...
                    <?php foreach ($categories as $cat): ?>
                        <tr>
                            ...
                            <td>
                                <a class="delete" href="admin_manage_categories.php?delete_id=<?= $cat['id'] ?>" onclick="return confirm('Are you sure you want to delete this category? All related news will remain but without this category.');">Delete ❌</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
