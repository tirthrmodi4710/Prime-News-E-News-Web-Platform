...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM journalists WHERE username='$username'";
    $result = $conn->query($sql);

    if ($result->num_rows == 1) {
        $journalist = $result->fetch_assoc();
        if ($password === $journalist['password']) {
            $_SESSION['journalist_id'] = $journalist['id'];
            $_SESSION['journalist_username'] = $journalist['username'];
...
<head>
    <meta charset="UTF-8">
    <title>Journalist Login - Prime Report</title>
    <style>
    ...
    <div class="login-container">
        <div class="login-box">
            <div class="login-header">
                ...
                <p>Access your journalist account</p>
            </div>
            ...
            <div class="journalist-badge">
                <span>Journalist Access</span>
            </div>
        </div>
    </div>
